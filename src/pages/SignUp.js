import './SignUp.css';
import man_smiling from '../images/man-smiling.jpg';
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-5">
                                                        ...
                                                        <h2 class="h2 text-center" id="welcome">Welcome!</h2>
                                                        <p class="text-center" id="tagline">Create a new MyCitadel account:</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <form action="#!">
                                                <div class="row gy-3 overflow-hidden">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="d-grid">
                                                            <button class="btn btn-dark btn-lg mt-3" id="signup" type="submit">Sign up</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
